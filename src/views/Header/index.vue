    ...
    <el-row :gutter="20">
      ...
      <el-col :span="6">
        ...
        <el-popover
          ...
          trigger="focus">
          <template #reference>
            <el-input placeholder="请输入内容" clearable v-model.trim="value" @keydown.enter="search"
      ...
      <el-col :span="4">
        ...
        <span v-else class="el-dropdown-link" @click="userLogin">
            <el-avatar style="vertical-align: middle;" :size="40"
...
<script setup>
  ...
  let boolean = ref(store.state.boolean)
  let value = ref()
  const instance = ref()
  const logout = () => {
    getLogout().then(res => {
